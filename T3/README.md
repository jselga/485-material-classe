...
Per executar els exemples necessites:

- **Java JDK 21 o superior**
- **NetBeans / IntelliJ / VSCode** (qualsevol IDE Java)
- Terminal o consola per executar programes Java
...
> Aquest repositori és un **exemple de com es documenten projectes a GitHub**.  
> A mesura que avanceu en el cicle, també haureu de documentar els vostres projectes amb un README similar.
